...
class Config:
    ...
    # MongoDB settings - strip whitespace/newlines (Render env vars can have hidden chars)
    _raw = (os.environ.get('MONGODB_URI') or os.environ.get('MONGO_URI') or '').strip()
    MONGO_URI = _raw if _raw else None
